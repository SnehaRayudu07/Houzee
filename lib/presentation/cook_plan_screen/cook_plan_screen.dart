import '../cook_plan_screen/widgets/planfooddeliveries1_item_widget.dart';
...
class CookPlanScreen extends GetWidget<CookPlanController> {
            ...
            body: Container(
                ...
                child: Container(
                    ...
                    child: Column(children: [
                      Text("lbl_cook_partner".tr,
                          style: theme.textTheme.displaySmall),
                      SizedBox(height: 66.v),
                      _buildCookPlanDescription(),
  ...
  /// Section Widget
  Widget _buildCookPlanDescription() {
    return Padding(
  ...
  Widget _buildPlanFoodDeliveries() {
    return SizedBox(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller.cookPlanModelObj.value
                .planfooddeliveries1ItemList.value.length,
            itemBuilder: (context, index) {
              Planfooddeliveries1ItemModel model = controller.cookPlanModelObj
                  .value.planfooddeliveries1ItemList.value[index];
              return Planfooddeliveries1ItemWidget(model);
            })));
  }
